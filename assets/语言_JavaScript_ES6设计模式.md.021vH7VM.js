import{F as e,b as t,m as n,p as r}from"./chunks/plugin-vue_export-helper.CL7LGUog.js";const i=JSON.parse(`{"title":"ES6设计模式","description":"使用ES6完成各种设计模式","frontmatter":{"title":"ES6设计模式","date":"2016-04-22T10:33:05.000Z","tags":["前端","javascript"],"categories":"技术文档","description":"使用ES6完成各种设计模式"},"headers":[],"relativePath":"语言/JavaScript/ES6设计模式.md","filePath":"语言/JavaScript/ES6设计模式.md","lastUpdated":1750738239000}`),a={name:`语言/JavaScript/ES6设计模式.md`};function o(t,i,a,o,s,c){return e(),n(`div`,null,i[0]||=[r(`<p>我认为设计模式虽然不长用,特别是在js这种函数式编程中,但是如果我们掌握了这些东西,会使我们的代码结构更优美,看起来更流畅,不一定比其他方式更好,但是会更符合个人的开发风格,我的开发风格就是_懒_.</p><h2 id="单例模式" tabindex="-1">单例模式 <a class="header-anchor" href="#单例模式" aria-label="Permalink to “单例模式”">​</a></h2><p>单例模式主要是在类new之后调用同一份数据,有点想其他语言的静态类，主意的是，ES6中所有的类都必须new了之后才能使用。所以单例模式就比较重要。</p><pre><code>    &quot;use strict&quot;;
...
</code></pre><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to “总结”">​</a></h2><p>设计模式只是为了编程的更加优美，并不是说所有的都能被固化，从而在所有的地方都被用到，而要结合具体的环境而编写适合的模式，这里列出的都只是目前我能将之抽象出来的，还有很多以后会补上。</p>`,14)])}var s=t(a,[[`render`,o]]);export{i as __pageData,s as default};