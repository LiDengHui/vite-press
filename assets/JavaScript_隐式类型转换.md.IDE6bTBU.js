import{_ as e,c as o,o as a,a3 as l}from"./chunks/framework.D-BI-jj5.js";const m=JSON.parse('{"title":"隐式类型转换","description":"","frontmatter":{"title":"隐式类型转换","date":"2019-08-05T17:32:30.000Z","tags":null},"headers":[],"relativePath":"JavaScript/隐式类型转换.md","filePath":"JavaScript/隐式类型转换.md","lastUpdated":1749107541000}'),t={name:"JavaScript/隐式类型转换.md"};function r(u,n,s,c,i,g){return a(),o("div",null,n[0]||(n[0]=[l(`<h2 id="字符串连接符与算数运算符" tabindex="-1">字符串连接符与算数运算符 <a class="header-anchor" href="#字符串连接符与算数运算符" aria-label="Permalink to “字符串连接符与算数运算符”">​</a></h2><pre><code>/*
*
...
// 引用数据类型存储在栈中，比较的是堆栈地址
console.log([] == []) // false
</code></pre>`,10)]))}const f=e(t,[["render",r]]);export{m as __pageData,f as default};
