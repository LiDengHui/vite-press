import{F as e,b as t,m as n,p as r}from"./chunks/plugin-vue_export-helper.Cyk5UgWo.js";const i=JSON.parse(`{"title":"js位运算","description":"js 位运算","frontmatter":{"title":"js位运算","date":"2016-11-21T11:35:45.000Z","tags":["javascript","算法"],"categories":"技术文档","description":"js 位运算"},"headers":[],"relativePath":"语言/JavaScript/js位运算.md","filePath":"语言/JavaScript/js位运算.md","lastUpdated":1750738239000}`),a={name:`语言/JavaScript/js位运算.md`};function o(t,i,a,o,s,c){return e(),n(`div`,null,i[0]||=[r(`<p>我们可能很少在编程中用位运算，如果没深入学习，可能也很难理解。平时的数值运算，其实是要先转换成二进制再进行运算的，而位运算就是直接进行二进制运算，所以位运算的执行效率肯定是更高的。下面通过一些实例来加深对位运算的理解。</p><h1 id="按位与" tabindex="-1">按位与(&amp;) <a class="header-anchor" href="#按位与" aria-label="Permalink to “按位与(&amp;)”">​</a></h1><p>&amp;&amp;运算符我们都知道，只有两个都为真，结果才为真。&amp;道理是一样的，只有两个数的值为1时，才返回1。例如1和3的按位与操作：</p><pre><code>			    0001
			 &amp;  0011
			---------
			    0001
    ...
    isPos(-1); // false
    isPos(1); // true
</code></pre><p>-1&gt;&gt;&gt;0虽然没有向右移动位数，但-1的二进制码已经变成了正数的二进制码：</p><p>所以-1&gt;&gt;&gt;0的值为4294967295。</p><p>总结</p><p>以上的例子在平常可能会比较容易用到或看到，也是属于比较容易理解的。一些比较复杂的、难理解的，我觉得应该尽量少用，因为会给阅读者带来困难，也会给自己带来麻烦。</p>`,54)])}var s=t(a,[[`render`,o]]);export{i as __pageData,s as default};