import{F as e,b as t,m as n,p as r}from"./chunks/plugin-vue_export-helper.TNYQ6xSD.js";const i=JSON.parse(`{"title":"隐式类型转换","description":"","frontmatter":{"title":"隐式类型转换","date":"2019-08-05T17:32:30.000Z","tags":null},"headers":[],"relativePath":"语言/JavaScript/隐式类型转换.md","filePath":"语言/JavaScript/隐式类型转换.md","lastUpdated":1750738239000}`),a={name:`语言/JavaScript/隐式类型转换.md`};function o(t,i,a,o,s,c){return e(),n(`div`,null,i[0]||=[r(`<h2 id="字符串连接符与算数运算符" tabindex="-1">字符串连接符与算数运算符 <a class="header-anchor" href="#字符串连接符与算数运算符" aria-label="Permalink to “字符串连接符与算数运算符”">​</a></h2><pre><code>/*
*
...
// 引用数据类型存储在栈中，比较的是堆栈地址
console.log([] == []) // false
</code></pre>`,10)])}var s=t(a,[[`render`,o]]);export{i as __pageData,s as default};