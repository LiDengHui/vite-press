import{_ as e,o as n,c as o,a9 as a,aK as r}from"./chunks/framework.STMWz9Nm.js";const b=JSON.parse('{"title":"beforeupload和upload","description":"","frontmatter":{},"headers":[],"relativePath":"浏览器/beforeupload和upload.md","filePath":"浏览器/beforeupload和upload.md","lastUpdated":1777106511000}'),l={name:"浏览器/beforeupload和upload.md"};function u(d,t,i,c,s,p){return n(),o("div",null,[...t[0]||(t[0]=[a(`<h1 id="beforeupload和upload" tabindex="-1">beforeupload和upload <a class="header-anchor" href="#beforeupload和upload" aria-label="Permalink to “beforeupload和upload”">​</a></h1><h2 id="beforeunload和-unload-的触发时间" tabindex="-1"><code>beforeunload</code>和 <code>unload</code> 的触发时间 <a class="header-anchor" href="#beforeunload和-unload-的触发时间" aria-label="Permalink to “beforeunload和 unload 的触发时间”">​</a></h2><pre><code>// beforeunload在新资源开始跳转或老资源刷新之前之前，可以取消加载
...
</code></pre><p>猜测点: 浏览器在资源卸载后最后一步，有可能存在<code>调优</code>,如取消事件系统，比如micotask和macotask等.<code>unload</code>的可能性要比<code>beforeunlaod</code>高。</p><p><img src="`+r+`" alt="" data-zoomable="true" loading="lazy"></p><h3 id="测试代码" tabindex="-1">测试代码 <a class="header-anchor" href="#测试代码" aria-label="Permalink to “测试代码”">​</a></h3><pre><code>  &lt;!DOCTYPE html&gt;
  &lt;html&gt;
      &lt;head&gt;
          &lt;meta charset=&quot;utf-8&quot;/&gt;
