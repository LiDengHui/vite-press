import{_ as e,o,c as a,a9 as t}from"./chunks/framework.STMWz9Nm.js";const m=JSON.parse('{"title":"隐式类型转换","description":"","frontmatter":{"title":"隐式类型转换","date":"2019-08-05T17:32:30.000Z","tags":null},"headers":[],"relativePath":"语言/JavaScript/隐式类型转换.md","filePath":"语言/JavaScript/隐式类型转换.md","lastUpdated":1777106511000}'),l={name:"语言/JavaScript/隐式类型转换.md"};function r(u,n,s,c,i,d){return o(),a("div",null,[...n[0]||(n[0]=[t(`<h2 id="字符串连接符与算数运算符" tabindex="-1">字符串连接符与算数运算符 <a class="header-anchor" href="#字符串连接符与算数运算符" aria-label="Permalink to “字符串连接符与算数运算符”">​</a></h2><pre><code>/*
*
