import{_ as e,c as t,o as a,a7 as p}from"./chunks/framework.DGe06YP7.js";const i=JSON.parse('{"title":"js位运算","description":"js 位运算","frontmatter":{"title":"js位运算","date":"2016-11-21T11:35:45.000Z","tags":["javascript","算法"],"categories":"技术文档","description":"js 位运算"},"headers":[],"relativePath":"语言/JavaScript/js位运算.md","filePath":"语言/JavaScript/js位运算.md","lastUpdated":1750738239000}'),r={name:"语言/JavaScript/js位运算.md"};function o(c,n,m,u,d,s){return a(),t("div",null,n[0]||(n[0]=[p(`<p>我们可能很少在编程中用位运算，如果没深入学习，可能也很难理解。平时的数值运算，其实是要先转换成二进制再进行运算的，而位运算就是直接进行二进制运算，所以位运算的执行效率肯定是更高的。下面通过一些实例来加深对位运算的理解。</p><h1 id="按位与" tabindex="-1">按位与(&amp;) <a class="header-anchor" href="#按位与" aria-label="Permalink to “按位与(&amp;)”">​</a></h1><p>&amp;&amp;运算符我们都知道，只有两个都为真，结果才为真。&amp;道理是一样的，只有两个数的值为1时，才返回1。例如1和3的按位与操作：</p><pre><code>			    0001
			 &amp;  0011
			---------
			    0001
