import{_ as e,c as o,o as a,a6 as l}from"./chunks/framework.mq8cK8gF.js";const m=JSON.parse('{"title":"隐式类型转换","description":"","frontmatter":{"title":"隐式类型转换","date":"2019-08-05T17:32:30.000Z","tags":null},"headers":[],"relativePath":"语言/JavaScript/隐式类型转换.md","filePath":"语言/JavaScript/隐式类型转换.md","lastUpdated":null}'),t={name:"语言/JavaScript/隐式类型转换.md"};function r(u,n,s,c,i,d){return a(),o("div",null,n[0]||(n[0]=[l(`<h2 id="字符串连接符与算数运算符" tabindex="-1">字符串连接符与算数运算符 <a class="header-anchor" href="#字符串连接符与算数运算符" aria-label="Permalink to “字符串连接符与算数运算符”">​</a></h2><pre><code>/*
*
