...
&lt;html lang=&quot;en&quot;&gt;
  ...
  &lt;/script&gt;
&lt;/html&gt;v
</code></pre><p>这个代码，就是检测统计时在刷新时的图片加载顺序情况。如图(注：logo是随便的一个普通图片，可以替换成其他的，加uid是为了每次有用新的图片)</p><h3 id="chrome-测一下" tabindex="-1">chrome 测一下 <a class="header-anchor" href="#chrome-测一下" aria-label="Permalink to “chrome 测一下”">​</a></h3><p><img src="https://raw.githubusercontent.com/LiDengHui/images/master/img20190810004819.png" alt="20190810004819.png" data-zoomable="true" loading="lazy"></p><p>form: <code>4-&gt;5-&gt;6-&gt;2-&gt;3-&gt;0-&gt;1</code> 发现什么了吗？xhr竟然比js内src要先发出(实效性很小，目前没搞清楚为什么，可能和浏览器事件执行有关系，xhr的队列比js内src请求队列，要有先执行，dom内src请求队列最后执行)，而dom内src最后才发出。如果不考虑安全，跨域因素，真的用ajax要更好，而且ajax后端能返回204状态码，没有返回内容，这更好。</p><h3 id="safari-测一下" tabindex="-1">safari 测一下 <a class="header-anchor" href="#safari-测一下" aria-label="Permalink to “safari 测一下”">​</a></h3><p><img src="https://raw.githubusercontent.com/LiDengHui/images/master/img20190810013434.png" alt="20190810013434.png" data-zoomable="true" loading="lazy"></p><p>form: <code>2-&gt;3-&gt;4-&gt;5-&gt;6-&gt;0-&gt;1</code> 调整xhr的调用顺序</p><p><img src="https://raw.githubusercontent.com/LiDengHui/images/master/img20190810014238.png" alt="20190810014238.png" data-zoomable="true" loading="lazy"> form: <code>4-&gt;2-&gt;3-&gt;5-&gt;6-&gt;0-&gt;1</code> 从图中看出safari对xhr和js内部src没有做区分，但是报错了，浏览器任务不安全，应为request的请求头中没有指名服务器信息，和请求格式等。由安全性问题，所以选择js内src最好，</p>`,32)])}var s=t(a,[[`render`,o]]);export{i as __pageData,s as default};